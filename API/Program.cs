...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Keystonedemo", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<KeystonedemoContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Keystonedemo API v1");
